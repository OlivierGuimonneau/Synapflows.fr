      ...
      <section className="terms-content">
        <div className="container">
          <div className="terms-section">
            ...
            <p>
              Le présent site, accessible à l'URL <strong>www.synapflows.fr</strong> (le « Site »), est édité par :
            </p>
            <div className="terms-info">
              <p>
                <strong>SynapFlows</strong><br />
                Entreprise spécialisée dans l'automatisation des processus métier et la création d'applications spécifiques<br />
                <br />
                <strong>Adresse:</strong> 24 rue du Thuel, Les Pioliers, 63310 Villeneuve-les-Cerfs<br />
                <strong>SIREN:</strong> 452 460 652<br />
                <strong>SIRET:</strong> 452 460 652 00053<br />
                <strong>Statut TVA:</strong> Exemption de TVA<br />
                <strong>Téléphone:</strong> 06 29 20 06 63<br />
                <strong>Email:</strong> olivier@synapflows.fr
              </p>
            </div>
            <p>
            ...
            <p>
              Le Site est hébergé par la société <strong>IONOS</strong>, situé 1&D rue Kellermann, 51100 Reims, France, (téléphone : +33 (0)1 72 74 89 00).
            </p>
            <p>
              Le Directeur de la publication du Site est <strong>Olivier Guimonneau</strong>.
            </p>
            <p>
              L'Exploitant peut être joint au numéro de téléphone suivant <strong>06 29 20 06 63</strong> et à l'adresse mail suivante <strong>olivier@synapflows.fr</strong>.
            </p>
          </div>
          ...
          <div className="terms-section">
            ...
            <p>
              Le Site est mis à la disposition de toute personne accédant au site (l' « Utilisateur ») pour fournir des informations sur l'automatisation des processus métier, la création d'applications web custom, l'intégration de systèmes, et les services d'intelligence artificielle proposés par SynapFlows.
            </p>
            <p>
            ...
            <p>
              Les informations et services proposés par le Site sont gratuits, et accessibles 24h/24 et 7 jours/7, sauf en cas de force majeure, de pannes informatiques, d'opérations de maintenance ou de problèmes liés aux réseaux de télécommunications.
            </p>
          </div>
          ...
          <div className="terms-section">
            ...
            <p>
              Pour davantage d'informations concernant l'utilisation de données à caractère personnel par l'Exploitant, veuillez lire attentivement la <strong>Politique de Confidentialité</strong>. Vous pouvez à tout moment consulter cette Politique sur le Site.
            </p>
            <p>
              L'Utilisateur reconnait avoir lu attentivement les présentes Conditions Générales d'Utilisation.
            </p>
            <p>
              En envoyant une demande de qualification via le formulaire présent sur le Site, l'Utilisateur confirme avoir pris connaissance des Conditions Générales d'Utilisation et les accepter, le rendant contractuellement lié par les termes des présentes Conditions Générales d'Utilisation.
            </p>
            <p>
              Les données personnelles collectées via le formulaire de qualification seront traitées conformément au Règlement Général sur la Protection des Données (RGPD) et à notre Politique de Confidentialité.
            </p>
          </div>
          ...
          <div className="terms-section">
            ...
            <p>
              En cas de modifications matérielles, l'Utilisateur sera informé au moyen d'un email et d'un avertissement sur le Site avant la mise en application de la modification.
            </p>
            <p>
            ...
            <div className="terms-info">
              <p>
                <strong>Email:</strong> olivier@synapflows.fr<br />
                <strong>Téléphone:</strong> 06 29 20 06 63<br />
                <strong>Adresse:</strong> 24 rue du Thuel, Les Pioliers, 63310 Villeneuve-les-Cerfs
              </p>
            </div>
            <p>
              En cas d'échec de la demande de réclamation auprès du service client ou en l'absence de réponse de ce service dans un délai de 30 jours, le Client peut soumettre le différend à la médiation ou aux juridictions compétentes.
            </p>
            ...
            <p>
              En accédant au Site et en utilisant ses services, notamment en soumettant le formulaire de qualification, l'Utilisateur confirme avoir pris connaissance des Conditions Générales d'Utilisation et les accepter, le rendant contractuellement lié par les termes des présentes Conditions Générales d'Utilisation.
            </p>
            <p>
